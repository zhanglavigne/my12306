...
class select:
    ...
    def call_login(self, auth=False,result={}):
        """
        登录回调方法
        :return:
        """
    ...
    def main(self):
        ...
        # cks=apiUtils.requestCookieJarToDict(self.httpClint.get_cookies_itself())
        # new_select=select()
        # new_select.httpClint.set_cookies_by_dict(cks)
